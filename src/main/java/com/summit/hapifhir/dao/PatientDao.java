...
import com.summit.hapifhir.dao.transform.PatientEntityToFHIRPatient;
import com.summit.hapifhir.entities.Name;
import com.summit.hapifhir.entities.PatientEntity;
import com.summit.hapifhir.entities.Telecom;
...
public class PatientDao implements IPatient {
	...
	public Patient create(FhirContext ctx, Patient patient) {
		...
		for (Identifier identifier : patient.getIdentifier()) {
			com.summit.hapifhir.entities.Identifier identifierE = new com.summit.hapifhir.entities.Identifier();
		...
		for (Address address : patient.getAddress()) {
			com.summit.hapifhir.entities.Address addressEntity = new com.summit.hapifhir.entities.Address();
